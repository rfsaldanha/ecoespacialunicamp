---
title: "Econometria espacial com R - Painéis de dados espaciais"
...
natregimes_montana.shp <- readOGR("data/natregimes_montana.gml")
...
summary(splm:::impacts.splm(modSAR_gm, listw = w1, time = 2))
```
...
summary(splm:::impacts.splm(modSAC_gm, listw = w1, time = 2))
```

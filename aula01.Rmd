---
title: "Econometria espacial com R - Aula 01"
...
Para ver como está ficando o seu notebook, clique no botão **Preview**. Uma página irá aparecer com a pré-visualização do seu notebook. Para exportar para HTML ou PDF, use a seta para abaixo ao lado do botão.
...
No chunk abaixo, realize a operação $((2+3(5))/10)^2$
...
No chunk abaixo, cálcule a raiz quadrada do logaritmo de 10
...
Para importar este arquivo CSV no \textsl{R}, teste o código abaixo. Se não funcionar, tente trocar "/" por "\\".

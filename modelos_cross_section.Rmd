---
title: "Econometria espacial com R - Modelos de cross section"
author: "Raphael Saldanha, Eduardo Almeida"
subtitle: Unicamp, julho de 2021
output:
...
# Modelos espaciais de cross section
...
# Abra o arquivo
montana.shp <- readOGR("data/natregimes_montana.gml")
...
summary(mod1.sar)
summary(spdep::impacts(mod1.sar, tr=trMat, R=1000), zstats=TRUE, short=TRUE)
```
...
summary(mod1.sac)
summary(spdep::impacts(mod1.sac, tr=trMat, R=1000), zstats=TRUE, short=TRUE)
```
...
summary(mod1.slx)
summary(spdep::impacts(mod1.slx, tr=trMat, R=1000), zstats=TRUE, short=TRUE)
```
...
summary(mod1.sdm)
summary(spdep::impacts(mod1.sdm, tr=trMat, R=1000), zstats=TRUE, short=TRUE)
```
